#!/bin/bash
BUILD_DIR="../build_dir/target-aarch64_cortex-a53_musl/linux-qualcommax_ipq807x"
STAGING_DIR_HOST="../staging_dir/host/"
ROOTFS_IMG="root.squashfs"

# copy root.squashfs and kernel to current dir
cp ${BUILD_DIR}/${ROOTFS_IMG} ./rootfs.img
cp ../bin/targets/qualcommax/ipq807x/openwrt-qualcommax-ipq807x-netgear_rax120v2-initramfs-uImage.itb ./kernel.itb
